...
The Encrypt and Decrypt runner files are both subclasses of Enigma class.
They use the instance methods of Enigma class interface the encryption process with txt files.
...
Enumerables have been chosen thoughtfully, and nested iterations have been avoided where possible.
...
Version Control. Below Expectations 2/4
Most commits include logical chunks of functionality.
However, there are an insufficient amount of pull requests.
